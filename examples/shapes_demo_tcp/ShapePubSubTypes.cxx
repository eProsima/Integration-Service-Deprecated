...
{
    setName("ShapeType");
    m_typeSize = static_cast<uint32_t>(ShapeType::getMaxCdrSerializedSize()) + 4 /*encapsulation*/;
    m_isGetKeyDefined = ShapeType::isKeyDefined();
    size_t keyLength = ShapeType::getKeyMaxCdrSerializedSize()>16 ? ShapeType::getKeyMaxCdrSerializedSize() : 16;
...
{
    ShapeType* p_type = static_cast<ShapeType*>(data); //Convert DATA to pointer of your type
...
std::function<uint32_t()> ShapeTypePubSubType::getSerializedSizeProvider(void* data)
{
    ...
    {
        return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<ShapeType*>(data))) + 4 /*encapsulation*/;
    };
}
...
bool ShapeTypePubSubType::getKey(void *data, InstanceHandle_t* handle, bool force_md5) {
    if(!m_isGetKeyDefined)
        return false;
    ShapeType* p_type = static_cast<ShapeType*>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),ShapeType::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.

...
TextPubSubType::TextPubSubType() {
    setName("Text");
    m_typeSize = (uint32_t)Text::getMaxCdrSerializedSize() + 4 /*encapsulation*/;
...
std::function<uint32_t()> TextPubSubType::getSerializedSizeProvider(void* data) {
    ...
    {
        return (uint32_t)type::getCdrSerializedSize(*static_cast<Text*>(data)) + 4 /*encapsulation*/;
    };
}
...
bool TextPubSubType::getKey(void *data, InstanceHandle_t* handle, bool force_md5) {
    ...
    if(force_md5 || Text::getKeyMaxCdrSerializedSize()>16)	{
        m_md5.init();

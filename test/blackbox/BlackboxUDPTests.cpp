...
TEST_F(BlackBox, String_1_1_UDP_UDP_Static)
{
    ...
    pub.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "StringType", 2912, &type, "Pub_String");

    ASSERT_TRUE(pub.isInitialized());

    sub.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 6374, &type, "Sub_String");
...
TEST_F(BlackBox, String_1_5_UDP_UDP_Static)
{
    ...
    sub1.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 6374, &type, "Sub1_String");
    sub2.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 8449, &type, "Sub2_String");
    sub3.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 8133, &type, "Sub3_String");
    sub4.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 5076, &type, "Sub4_String");
    sub5.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 3886, &type, "Sub5_String");
...
TEST_F(BlackBox, String_3_1_UDP_UDP_Static)
{
    ...
    pub1.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "StringType", 2912, &type, "Pub1_String");
    pub2.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "StringType", 7318, &type, "Pub2_String");
    pub3.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "StringType", 2603, &type, "Pub3_String");
...
TEST_F(BlackBox, Data1mb_1_1_UDP_UDP_Static)
{
    ...
    sub.init(UDP, RELIABLE_RELIABILITY_QOS, "Data1mbTopic", 6374, &type, "Sub_Data1mb");

    ASSERT_TRUE(sub.isInitialized());

    pub.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "Data1mbTopic", 2912, &type, "Pub_Data1mb");

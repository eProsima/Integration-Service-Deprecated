...
TEST_F(Benchmark, String_1_1_Static)
{
    ...
    // Direct communication
    {
        ...
        pub.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "StringType", 8096, &type, "Pub_String");

        ASSERT_TRUE(pub.isInitialized());

        sub.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 8096, &type, "Sub_String");
    ...
    // IS communication
    {
        ...
        sub.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 8787, &type, "Sub_String");
...
TEST_F(Benchmark, String_1_5_Static)
{
    ...
    // Direct communication
    {
        ...
        sub1.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 8096, &type, "Sub1_String");
        sub2.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 8096, &type, "Sub2_String");
        sub3.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 8096, &type, "Sub3_String");
        sub4.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 8096, &type, "Sub4_String");
        sub5.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 8096, &type, "Sub5_String");
    ...
    // IS communication
    {
        ...
        sub1.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 8787, &type, "Sub1_String");
        sub2.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 1260, &type, "Sub2_String");
        sub3.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 3039, &type, "Sub3_String");
        sub4.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 154, &type, "Sub4_String");
        sub5.init(UDP, RELIABLE_RELIABILITY_QOS, "StringType", 9408, &type, "Sub5_String");
...
TEST_F(Benchmark, String_3_1_Static)
{
    ...
    // Direct communication
    {
        ...
        pub1.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "StringType", 8096, &type, "Pub1_String");
        pub2.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "StringType", 8096, &type, "Pub2_String");
        pub3.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "StringType", 8096, &type, "Pub3_String");
    ...
    // IS communication
    {
        ...
        pub1.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "StringType", 8096, &type, "Pub1_String");
        pub2.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "StringType", 3146, &type, "Pub2_String");
        pub3.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "StringType", 7593, &type, "Pub3_String");
...
TEST_F(Benchmark, Data1mb_1_5_Static)
{
    ...
    // Direct communication
    {
        ...
        pub.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "Data1mbTopic", 8096, &type, "Pub_Data1mb");

        ASSERT_TRUE(pub.isInitialized());

        sub1.init(UDP, RELIABLE_RELIABILITY_QOS, "Data1mbTopic", 8096, &type, "Sub1_Data1mb");
        sub2.init(UDP, RELIABLE_RELIABILITY_QOS, "Data1mbTopic", 8096, &type, "Sub2_Data1mb");
        sub3.init(UDP, RELIABLE_RELIABILITY_QOS, "Data1mbTopic", 8096, &type, "Sub3_Data1mb");
        sub4.init(UDP, RELIABLE_RELIABILITY_QOS, "Data1mbTopic", 8096, &type, "Sub4_Data1mb");
        sub5.init(UDP, RELIABLE_RELIABILITY_QOS, "Data1mbTopic", 8096, &type, "Sub5_Data1mb");
    ...
    // IS communication
    {
        ...
        sub1.init(UDP, RELIABLE_RELIABILITY_QOS, "Data1mbTopic", 8787, &type, "Sub1_Data1mb");
        sub2.init(UDP, RELIABLE_RELIABILITY_QOS, "Data1mbTopic", 1260, &type, "Sub2_Data1mb");
        sub3.init(UDP, RELIABLE_RELIABILITY_QOS, "Data1mbTopic", 3039, &type, "Sub3_Data1mb");
        sub4.init(UDP, RELIABLE_RELIABILITY_QOS, "Data1mbTopic", 154, &type, "Sub4_Data1mb");
        sub5.init(UDP, RELIABLE_RELIABILITY_QOS, "Data1mbTopic", 9408, &type, "Sub5_Data1mb");
...
TEST_F(Benchmark, Data1mb_3_1_Static)
{
    ...
    // Direct communication
    {
        ...
        pub1.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "Data1mbTopic", 8096, &type, "Pub1_Data1mb");
        pub2.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "Data1mbTopic", 8096, &type, "Pub2_Data1mb");
        pub3.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "Data1mbTopic", 8096, &type, "Pub3_Data1mb");

        ASSERT_TRUE(pub1.isInitialized());
        ASSERT_TRUE(pub2.isInitialized());
        ASSERT_TRUE(pub3.isInitialized());

        sub.init(UDP, RELIABLE_RELIABILITY_QOS, "Data1mbTopic", 8096, &type, "Sub_Data1mb");
    ...
    // IS communication
    {
        ...
        pub1.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "Data1mbTopic", 8096, &type, "Pub1_Data1mb");
        pub2.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "Data1mbTopic", 3146, &type, "Pub2_Data1mb");
        pub3.init(UDP, RELIABLE_RELIABILITY_QOS, 5, 10, "Data1mbTopic", 7593, &type, "Pub3_Data1mb");

        ASSERT_TRUE(pub1.isInitialized());
        ASSERT_TRUE(pub2.isInitialized());
        ASSERT_TRUE(pub3.isInitialized());

        sub.init(UDP, RELIABLE_RELIABILITY_QOS, "Data1mbTopic", 8787, &type, "Sub_Data1mb");
